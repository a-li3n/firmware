...
#if defined ( ESP\_IDF\_VERSION\_VAL )
 #if ESP\_IDF\_VERSION >= ESP\_IDF\_VERSION\_VAL(5, 5, 0)
 #define LGFX\_HAL\_FUNC\_SEL
 #endif
#endif
...
//----------------------------------------------------------------------------
 ...
 {
 #if defined LGFX\_HAL\_FUNC\_SEL
 gpio\_hal\_context\_t gpio\_hal = {
 .dev = GPIO\_HAL\_GET\_HW(GPIO\_PORT\_0)
 };
 gpio\_hal\_func\_sel(&gpio\_hal, pin, PIN\_FUNC\_GPIO);
 #else
